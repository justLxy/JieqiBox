export default {
  ...
  uciOptions: {
    ...
    loadFailed: '读取引擎选项失败，请确认引擎仍在运行。',
    applyFailed: '应用引擎选项失败，设置尚未保存。',
    engineBusy: '引擎正在搜索，请先停止分析后再修改选项。',
    ...
    optionDescriptions: {
      ...
      Hash: '引擎的哈希表大小（单位 MB）。更大并不一定更快；日常分析通常 512 MB 到 4 GiB 已足够。避免占满内存，并为系统和界面保留充足空间，否则内存延迟、带宽竞争或交换会降低搜索速度。',
      'Clear Hash': '清除哈希表。',
      MultiPV:
